...
# checkpointer = ModelCheckpoint(filepath = r'D:\Courses\Udacity Nanodegrees\Machine Learning Nanodegree\Capstone Project\best_weights\initial.hdf5', verbose = 1, save_best_only = True)
...
#loading the weights
model.load_weights(r'D:\Courses\Udacity Nanodegrees\Machine Learning Nanodegree\Capstone Project\best_weights\initial.hdf5')
